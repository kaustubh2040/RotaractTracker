...
const AdminDashboard: React.FC = () => {
    const { memberStats, activities, addAnnouncement, sendNotification, members, dbStatus, settings, updateSettings, publicEvents, addPublicEvent, deletePublicEvent } = useClubData();
    const [activeTab, setActiveTab] = useState<'overview' | 'approvals' | 'members' | 'broadcast' | 'events' | 'settings'>('overview');
    ...
    const navItems = [
        ...
        { id: 'events', label: 'Web Content', icon: <path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /> },
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-[calc(100vh-8rem)]">
            ...
            <div className="flex-1 space-y-6">
                ...
                {activeTab === 'events' && (
                    <div className="space-y-6 animate-fadeIn">
                        <Card title="Manage Web Content (Home Page)">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <input value={evtImg} onChange={e => setEvtImg(e.target.value)} placeholder="Image URL (Unsplash or Imgur)" className="p-3 bg-gray-700 rounded-xl border border-gray-600 text-white" />
                            ...
                            <button onClick={handleSaveEvent} className="mt-4 w-full py-3 bg-teal-600 rounded-xl font-bold uppercase tracking-widest text-xs">Publish to Actra Home</button>
                        </Card>
