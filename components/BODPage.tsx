            ...
            <div className="relative py-24 bg-gray-800/40 border-b border-gray-800 overflow-hidden">
                <div className="container mx-auto px-6 text-center">
                    <button 
                        ...
                        className="mb-8 text-teal-400 hover:text-white flex items-center justify-center mx-auto uppercase text-[10px] font-black tracking-widest group"
                    >
                    ...
                    {bodLeadership.map(member => (
                        <div key={member.id} className="group flex flex-col">
                            <div className="relative aspect-[3/4] bg-gray-800 rounded-[3rem] overflow-hidden border-2 border-gray-800 group-hover:border-teal-500/40 transition-all duration-500 shadow-2xl shadow-black/50">
                                {member.photoUrl ? (
                                    <img src={member.photoUrl} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105" alt={member.name} />
                                ) : (
