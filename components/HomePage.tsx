                        ...
                        <div className="max-w-5xl mx-auto space-y-12">
                            ...
                            <div className="flex justify-center pt-8">
                                <button 
                                    ...
                                    className="flex items-center text-teal-400 hover:text-white transition-all duration-300 uppercase text-[10px] font-black tracking-widest group bg-gray-800/50 px-8 py-4 rounded-full border border-gray-700 hover:border-teal-500/50 hover:scale-105 active:scale-95"
                                >
            ...
            <div className="animate-fadeIn bg-gray-900 min-h-screen pb-20">
                <div className="relative h-[40vh] lg:h-[50vh] w-full overflow-hidden">
                    ...
                    <div className="absolute top-8 left-8 z-20">
                        <button 
                            onClick={() => { setSelectedEvent(null); setRegStatus('idle'); }}
                            className="p-3 bg-gray-900/60 backdrop-blur-md border border-white/10 rounded-full text-white hover:bg-teal-500 hover:text-gray-950 transition-all shadow-2xl group active:scale-90"
                        >
                    ...
                    <div className="absolute bottom-12 left-8 lg:left-24 right-8 z-10 transition-all duration-700">
                        <span className="bg-teal-500 text-gray-950 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest mb-4 inline-block shadow-lg transform hover:scale-110 transition-transform cursor-default">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    {settings.clubLogoUrl && (
                        <div className="flex justify-center mb-8">
                            <img src={settings.clubLogoUrl} alt="Logo" className="h-24 w-24 sm:h-32 sm:w-32 object-contain bg-gray-900/50 p-2 rounded-2xl border border-gray-800 shadow-2xl animate-float transition-transform duration-500 hover:scale-110" />
                        </div>
                    )}
                    <h1 className="text-7xl lg:text-[10rem] font-black text-white tracking-tighter uppercase mb-2 drop-shadow-2xl transition-all duration-700 hover:tracking-tight cursor-default">
                        {settings.appName}
                    </h1>
                    <h2 className="text-[10px] lg:text-[14px] font-black uppercase tracking-[0.5em] text-teal-400 mb-10 opacity-80">
                    ...
                    <p className="mt-8 text-sm text-gray-500 font-medium max-w-2xl mx-auto leading-relaxed opacity-60">
                    ...
                    <div className="mt-12 flex justify-center items-center">
                        <button onClick={() => setCurrentPage('login')} className="w-full sm:w-auto px-12 py-5 bg-teal-600 hover:bg-teal-500 text-white font-black uppercase tracking-widest rounded-full transition-all shadow-2xl hover:shadow-teal-500/20 hover:scale-105 active:scale-95 text-sm">Join Community</button>
                    </div>
                </div>
            </section>
