    ...
    return (
        <div className="animate-fadeIn min-h-[calc(100vh-5rem)] bg-gray-900 pb-24">
            ...
            <div className="container mx-auto px-6 mt-16 max-w-5xl">
                <div className="bg-gray-800 rounded-[2rem] border border-gray-700 shadow-2xl overflow-hidden">
                                    ...
                                    <tr key={member.userId} className={`group hover:bg-gray-700/30 transition-colors ${index < 3 ? 'bg-teal-500/5' : ''}`}>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center">
                                                <p className="text-lg font-bold text-white group-hover:text-teal-400 transition-colors">{member.name}</p>
                                                {index < 3 && (
                                                    <span className="ml-3 px-2 py-0.5 rounded text-[8px] font-black bg-teal-500/20 text-teal-400 uppercase tracking-widest border border-teal-500/30">
                                                        Top Tier
                                                    </span>
                                                )}
                                            </div>
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <span className="text-2xl font-black text-teal-400 tracking-tighter">{member.totalPoints}</span>
