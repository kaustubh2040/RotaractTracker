                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full p-4 pr-12 bg-gray-700 border border-gray-600 text-white rounded-xl focus:ring-2 focus:ring-teal-500 transition-all outline-none placeholder-gray-500"
                            />
                            <button
                                type="button"
