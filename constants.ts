...
export const INITIAL_ACTIVITIES: Activity[] = [
  ...
  { id: 'act2', userId: 'user2', userName: 'Bob Williams', type: ActivityType.EVENT_ATTENDANCE, description: 'Volunteered at the community cleanup drive', date: '2023-10-06', points: 10, status: ActivityStatus.APPROVED },
  ...
  { id: 'act5', userId: 'user4', userName: 'EVENT_ATTENDANCE', type: ActivityType.EVENT_ATTENDANCE, description: 'Attended the guest speaker seminar', date: '2023-09-28', points: 10, status: ActivityStatus.APPROVED },
  ...
  { id: 'act9', userId: 'user8', userName: 'Hannah Wilson', type: ActivityType.MEETING_ATTENDANCE, description: 'Participated in the tree plantation drive.', date: '2023-10-12', points: 15, status: ActivityStatus.PENDING },
